...
return [
    ...
    'views' => [
        [
            ...
            'data' => [
                'siteTitle'     => 'öteborg ',
                'siteTagline'   => 'Sidan som har allt om Göteborg.',
            ], 
            'sort' => -1
        ],
        ...
        ['region' => 'topheader', 'template' => 'goteborg/topheader', 'data' => [], 'sort' => -1],
    ],
    ...
    'data' => [
        ...
        'title_append' => ' - Göteborg',

        // Stylesheets
        'stylesheets' => ['css/allt-om-goteborg/style.php'],
